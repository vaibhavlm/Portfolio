...
const Header = (props)=>{
  ...
  return(
      <React.Fragment>
          ...
          <nav className="navbar navbar-light bg-light site-navbar navbar-expand-sm fixed-top" >
           <div className="container">
               <a className="navbar-brand" href="#home">Portfolio</a>
               <Button className="navbar-toggler" onClick={()=> toggleNav(!isNav)}><i className="navbar-toggler-icon"></i></Button>
               <Collapse isOpen={isNav} navbar>
               <ul class="navbar-nav mr-auto" onClick={()=> toggleNav(!isNav)}>
